var jsPsychInstructions = (function (jspsych) {
  ...
  class InstructionsPlugin {
    ...
    create_simulation_data(trial, simulation_options) {
      ...
      if (
        !((_a = simulation_options.data) === null || _a === void 0
          ? void 0
          : _a.view_history) &&
        !((_b = simulation_options.data) === null || _b === void 0
          ? void 0
          : _b.rt)
      ) {
      ...
      if (
        !((_c = simulation_options.data) === null || _c === void 0
          ? void 0
          : _c.view_history) &&
        ((_d = simulation_options.data) === null || _d === void 0
          ? void 0
          : _d.rt)
      ) {
        ...
        const avg_rt_per_page =
          simulation_options.data.rt / view_history.length;
        let total_time = 0;
      ...
      if (
        ((_e = simulation_options.data) === null || _e === void 0
          ? void 0
          : _e.view_history) &&
        !((_f = simulation_options.data) === null || _f === void 0
          ? void 0
          : _f.rt)
      ) {
