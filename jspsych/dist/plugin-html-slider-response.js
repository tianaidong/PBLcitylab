var jsPsychHtmlSliderResponse = (function (jspsych) {
    ...
    class HtmlSliderResponsePlugin {
        ...
        trial(display_element, trial) {
            ...
            html +=
                '<div class="jspsych-html-slider-response-container" style="margin: 0 auto 3em auto; ';
            ...
            html += '">';
            if (trial.show_value) {
                  html += '<input type="range"  class="jspsych-slider" value="' + trial.slider_start + '"min="' + trial.min + '" max="' + trial.max + '" step="' + trial.step + '" id="jspsych-html-slider-response-response" oninput="this.nextElementSibling.value = this.value"></input><output class="current_value">' + trial.slider_start + '</output>';
            } else {
                html += '<input type="range" class="jspsych-slider" value="' +
                    ...
                    '" step="' +
                    trial.step +
                    '" id="jspsych-html-slider-response-response"></input><output></output>';
            }
