var jsPsychSurveyMultiChoiceH = (function (jspsych) {
    'use strict';
    ...
    class SurveyMultiChoicePlugin {
        ...
        trial(display_element, trial) {
            ...
            for (var i = 0; i < trial.questions.length; i++) {
                ...
                // html += '<div class="jspsych-survey-multi-choice-options" style="display: flex; flex-direction: row; justify-content: center; gap: 0.25em;">';
                ...
                //     html += '<div id="' + option_id_name + '" class="jspsych-survey-multi-choice-option" style="display: flex; align-items: center; flex-direction: row; justify-content: center;">';
                //     if (j === 0) {
                //         // Move the first label to the left of the radio button
                //         html += '<div style="display: flex; align-items: center; margin-right: 2em;">';
                ...
                //         html += '</div>';
                //     } else if (j === question.options.length - 1) {
                //         // Display the last radio button and label on the right
                //         html += '<div style="display: flex; align-items: center; margin-right: -2em;">';
                //         html += '<input type="radio" name="' + input_name + '" id="' + input_id + '" value="' + question.options[j] + '" ' + required_attr + "></input>";
                //         html += '&nbsp;<label class="jspsych-survey-multi-choice-text" for="' + input_id + '">' + question.options[j] + '</label>';
                //     } else {
                //         // Display remaining radio buttons and labels horizontally
                //         html += '<input type="radio" name="' + input_name + '" id="' + input_id + '" value="' + question.options[j] + '" ' + required_attr + "></input>";
                //         html += '&nbsp;<label class="jspsych-survey-multi-choice-text" for="' + input_id + '">' + question.options[j] + '</label>';
                //     }
                //     html += "</div>";
                ...
                // create option radio buttons
                html += '<div class="jspsych-survey-multi-choice-options" style="display: flex; flex-direction: row; justify-content: center; align-items: center; width: 100%;">';

                // Add left label with fixed width
                html += '<div style="width: 150px; text-align: right; padding-right: 150px;"><div class="jspsych-survey-multi-choice-option-label" style="white-space: nowrap;">' + question.options[0] + '</div></div>';

                // Create a container for radio buttons
                html += '<div style="display: flex; justify-content: center; align-items: center; width: 300px;">'; // Adjust width as needed
                ...
                for (var j = 0; j < question.options.length; j++) {
                    ...
                    html += '<div id="' + option_id_name + '" class="jspsych-survey-multi-choice-option" style="display: flex; align-items: center; justify-content: center; flex: 1;">';
                    html += '<input type="radio" name="' + input_name + '" id="' + input_id + '" value="' + question.options[j] + '" ' + required_attr + '></input>';
                    html += '</div>';
                }
                ...
                // Add right label with fixed width
                html += '<div style="width: 150px; text-align: left; padding-left: 90px;"><div class="jspsych-survey-multi-choice-option-label" style="white-space: nowrap;">' + question.options[question.options.length - 1] + '</div></div>';
            ...
            html +=
                '<input type="submit" id="' +
                    ...
                    '-next" class="' +
                    plugin_id_name +
                    ' jspsych-btn" style="margin-top: 60px;"' +
